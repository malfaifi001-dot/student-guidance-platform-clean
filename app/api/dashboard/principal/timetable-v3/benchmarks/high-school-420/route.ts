...
import {
  createHighSchool420GenerationProblem,
  getHighSchool420BenchmarkSummary,
} from "@/lib/timetable-v3/benchmarks/high-school-420-scenario";
    ...
    return NextResponse.json(
      {
        ok: false,
        error:
          "NOT_AVAILABLE_OUTSIDE_DEVELOPMENT",
      },
      {
        status: 404,
      },
