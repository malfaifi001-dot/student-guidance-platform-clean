    ...
    <div className="space-y-8">
      <section className="rounded-[2rem] bg-gradient-to-br from-slate-900 to-slate-800 p-8 text-white shadow-2xl">
        ...
        <p className="mt-4 max-w-3xl leading-8 text-slate-300">
          كل Workflow يتم رفعه مرتبط بخدمة محددة ومستقل عن باقي الخدمات.
        </p>
      </section>
        ...
        {dashboardServices.map((service) => {
          ...
          return (
            <Link
              ...
              className="group rounded-[2rem] border border-slate-200 bg-white p-6 card-shadow transition hover:-translate-y-1 hover:shadow-xl"
            >
              ...
              <div className="mt-6 rounded-2xl bg-slate-50 p-4 text-sm">
                {activeWorkflow ? (
                  ...
                  <p className="font-bold text-slate-400">لا يوجد Workflow مفعل</p>
                )}
              </div>
            </Link>
          );
