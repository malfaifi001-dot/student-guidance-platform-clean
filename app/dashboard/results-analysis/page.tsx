...
import { buildResultsAnalysisListWhere } from "@/lib/results-analysis/results-analysis-access";
    ...
    <main className="space-y-8">
      <section className="rounded-[2rem] bg-gradient-to-br from-indigo-600 to-blue-500 p-10 text-white shadow-2xl">
        ...
        <p className="mt-5 max-w-3xl text-lg leading-8 text-blue-50">
          رفع وتحليل نتائج الطلاب والطالبات من ملفات Excel مع مؤشرات أداء ورسوم وتحليلات محفوظة.
        </p>
