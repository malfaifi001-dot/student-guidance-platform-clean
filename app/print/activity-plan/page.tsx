...
.activity-plan-print-table { width: 100%; table-layout: fixed; border-collapse: collapse; color: #263238; font-size: 7pt; }
.activity-plan-print-table th, .activity-plan-print-table td { height: 6.4mm; padding: .7mm 1mm; border: .25mm solid #aeb9b6; overflow: hidden; line-height: 1.15; text-align: center; vertical-align: middle; overflow-wrap: anywhere; }
.activity-plan-print-table thead th { height: 8mm; color: #fff; background: #5b7659; font-size: 7pt; font-weight: 900; }
...
.activity-plan-print-day { width: 25mm; color: #244d40; background: #e2f0e5 !important; font-size: 8pt; font-weight: 900; }
.activity-plan-print-day span, .activity-plan-print-day small { display: block; }
.activity-plan-print-day small { margin-top: 1mm; direction: ltr; font-size: 7pt; font-weight: 900; }
.activity-plan-print-row-label { width: 23mm; color: #35524b; background: #f4f7f5; font-size: 7pt; font-weight: 900; }
.activity-plan-print-table td { background: #fff; font-weight: 700; }
.activity-plan-program-cell { font-weight: 900 !important; }
...
@media print { html, body { background: #fff !important; } body { padding: 0 !important; } .activity-plan-print-page { margin: 0; box-shadow: none; } }
`;
