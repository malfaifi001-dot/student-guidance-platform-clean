...
export function ActivityPlanTenPercentPrintDocument({ rows, stage, academicYear, schoolName, educationDepartment, logoUrl, activityLeaderName, activityLeaderSignatureUrl, principalName, principalSignatureUrl }: Props) {
  return <>
    <style>{`@page{size:A4 landscape;margin:8mm}.activity-plan-ten-percent-print-page{width:100%;height:auto!important;min-height:194mm;max-height:none!important;margin:0 auto;padding:0 0 2mm!important;overflow:visible!important;page-break-after:auto!important;break-after:auto!important;background:#F8FAFC;display:flex;flex-direction:column}.activity-plan-ten-percent-print-page .curriculum-print-footer{position:static!important;margin-top:auto;padding-top:5mm;break-inside:avoid;page-break-inside:avoid}.activity-plan-ten-percent-print-page .curriculum-print-signature-row{break-inside:avoid;page-break-inside:avoid;padding-bottom:4.5mm}.ten-percent-plan-a4{width:100%;min-height:194mm;display:flex;flex-direction:column}.ten-percent-plan-title{display:flex;align-items:center;justify-content:space-between;gap:5mm;margin:4mm 0 4mm;padding:3mm 2mm 3mm;border-bottom:2px solid #D7E3EA;color:#16324F;background:#EEF4F7}.ten-percent-plan-title h1{margin:0;font-size:15pt;font-weight:900;line-height:1.2}.ten-percent-plan-title span{padding:2mm 4mm;border:1px solid #D7E3EA;border-radius:2mm;background:#F1F5F9;font-size:9pt;font-weight:900;color:#16324F}.ten-percent-plan-table-wrap{flex:0 0 auto;overflow:visible}.ten-percent-plan-table{width:100%;table-layout:fixed;border-collapse:collapse;color:#1F2937;background:#F8FAFC;font-size:8.2pt}.ten-percent-plan-table th,.ten-percent-plan-table td{padding:2.4mm 2mm;border:.25mm solid #D7E3EA;text-align:center;vertical-align:middle;overflow-wrap:anywhere}.ten-percent-plan-table thead{display:table-header-group}.ten-percent-plan-table thead th{color:#16324F;background:#EAF2F8;font-size:8.2pt;font-weight:900}.ten-percent-plan-table thead tr:first-child th{background:#EEF4F7}.ten-percent-plan-table tbody td{background:#fff;color:#1F2937;font-weight:700;line-height:1.35}.ten-percent-plan-table tbody tr{break-inside:avoid;page-break-inside:avoid}.ten-percent-domain-list,.ten-percent-program-list{display:flex;flex-direction:column;align-items:stretch;gap:1.2mm}.ten-percent-domain-chip{display:block;padding:1.2mm;border:1px solid;border-radius:1.5mm;font-size:7.5pt;font-weight:900}.ten-percent-program-line{display:flex;flex-direction:column;gap:.5mm}.ten-percent-program-line small{color:#64748B;font-size:6.4pt;font-weight:700}.ten-percent-multiline{white-space:pre-line}.ten-percent-empty{padding:12mm!important;color:#64748B!important;background:#F1F5F9!important;font-weight:800!important}@media print{html,body{margin:0!important;padding:0!important;background:#F8FAFC!important}.activity-plan-ten-percent-print-page{box-shadow:none}.ten-percent-plan-table{font-size:8pt}}`}</style>
