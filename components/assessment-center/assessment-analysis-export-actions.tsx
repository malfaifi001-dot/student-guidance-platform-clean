  ...
  return (
    <>
      <NativeDownloadLink
        ...
        className={className || "inline-flex h-10 min-w-[92px] items-center justify-center gap-1.5 rounded-xl border border-white/25 bg-white/15 px-4 text-sm font-black text-white shadow-sm transition hover:bg-white/20"}
      >
        <span>Excel</span>
