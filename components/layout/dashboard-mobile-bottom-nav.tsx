...
export function DashboardMobileBottomNav({ role }: DashboardMobileBottomNavProps) {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-3 bottom-3 z-50 mx-auto max-w-md rounded-[1.5rem] border border-slate-200/80 bg-white/90 p-1.5 shadow-[0_12px_30px_rgba(15,23,42,0.12)] backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/90 dark:shadow-[0_12px_30px_rgba(2,6,23,0.4)] md:hidden"
