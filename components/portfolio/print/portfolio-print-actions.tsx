  ...
  return (
    <div className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 px-4 py-3 backdrop-blur print:hidden">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3">
        ...
        <button type="button" disabled={print.status === "loading"} onClick={() => void print.runPrintExport({ exportUrl: downloadHref, fileName, deliveryMode: "direct", directDownloadAcknowledgement: { cookieNamePrefix: "teachix_portfolio_download_", timeoutMs: 85_000, trace: "portfolio" }, progressTitle: "جاري تجهيز ملف الإنجاز", progressMessage: "يتم الآن تجهيز ملف الإنجاز للتحميل، الرجاء الانتظار...", fallbackProgressTitle: "جاري تجهيز ملف الإنجاز للمعاينة", fallbackProgressMessage: "يتم الآن تجهيز ملف الإنجاز للمعاينة، الرجاء الانتظار...", blockedTitle: "معاينة ملف الإنجاز", errorTitle: "تعذر تحميل ملف الإنجاز", errorMessage: "تم إنشاء طلب التحميل، لكن لم يتم تأكيد وصول ملف PDF إلى الجهاز. حاول مرة أخرى، وإذا استمرت المشكلة أعد فتح المعاينة ثم أعد التحميل." })} className="inline-flex items-center gap-2 rounded-2xl bg-slate-950 px-5 py-2.5 text-sm font-black text-white transition hover:bg-slate-800 disabled:opacity-60">
