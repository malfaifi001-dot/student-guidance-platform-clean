  ...
  return [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          title: "ملخص الحالة",
          content:
            "يعرض هذا التقرير نموذجًا خامًا للتصميم قبل استخدامه داخل الاستديو. الهدف من هذه الصفحة هو معاينة توزيع الترويسة، المحتوى، البطاقات، الهوامش، والفوتر.\n\nيمكن للموجه اختيار التصميم المناسب حسب نوع التقرير: حالة إرشادية، متابعة سلوكية، برنامج إرشادي، شواهد، أو خطاب رسمي.",
          variant: "card",
          align: "right",
          showTitle: true,
          placement: "flow",
        ...
        <div className="mb-6 flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm font-bold leading-7 text-slate-500">
              عاين شكل التقرير قبل استخدامه في الاستديو. هذه الصفحة تعرض
