    ...
    <div className="space-y-4 text-slate-950 dark:text-slate-100" dir="rtl">
      <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            {payload?.survey ? (
              <>
                <p className="mt-1 text-base font-bold text-slate-800 dark:text-slate-200">{payload.survey.title}</p>
      ...
      {error ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-1 text-xl font-bold text-slate-950 dark:text-white">{payload?.totals.allResponses || 0}</p>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <p className="text-sm text-slate-500">النتائج المعروضة</p>
          <p className="mt-1 text-xl font-bold text-sky-700">{payload?.totals.filteredResponses || 0}</p>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <p className="text-sm text-slate-500">عدد الأسئلة</p>
          <p className="mt-1 text-xl font-bold text-slate-950 dark:text-white">{payload?.totals.questions || 0}</p>
        </div>
      </section>
